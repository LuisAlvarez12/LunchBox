...
public struct AsyncSecondaryButton: View {
    ...
    public init(text: LocalizedStringKey, color: Color = Color.blue, transparent: Bool = false, disabled: Bool = false, action: @escaping () async -> Void) {
        self.text = text
        self.color = color
        self.action = action
...
public struct SecondaryButton: View {
    ...
    public init(text: LocalizedStringKey, color: Color = Color.blue, transparent: Bool = false, disabled: Bool = false, action: @escaping () -> Void) {
        self.text = text
        self.color = color
        self.action = action
        self.disabled = disabled
